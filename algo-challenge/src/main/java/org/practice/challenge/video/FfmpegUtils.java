...
public class FfmpegUtils {
     ...
     */
    private static String saveMediaPath = "C:\\Users\\Administrator\\Desktop\\";
    /**
     * 保存音频、视频的临时文件夹，不存在会自动创建
     */
    private static String tempMediaPath = "C:\\Users\\Administrator\\Desktop\\";
    /**
     * 保存图片截图的文件夹，不存在会自动创建
     */
    private static String picturMediaPath = "C:\\Users\\Administrator\\Desktop\\";
    ...
    public static void mergeSilent_VideoAudio(String videoResourcesPath, String audioResourcesPath) {
        ...
        command.add("-acodec");
        command.add("copy");
        command.add(saveMediaPath + "ff_" +videoResourcesPath.substring(videoResourcesPath.lastIndexOf("\\") + 1));
        commandStart(command);
    }
    ...
    public static List<String> videoAudioInfo(String videoAudioResourcesPath) {
        ...
        command.add("format=format_name,duration,size,bit_rate");
        command.add("-v");
        command.add("quiet");
